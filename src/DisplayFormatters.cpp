...
const char *DisplayFormatters::getModemPresetDisplayName(meshtastic_LoRaConfig_ModemPreset preset, bool useShortName,
                                                         bool usePreset)
{
...
const char *DisplayFormatters::getDeviceRole(meshtastic_Config_DeviceConfig_Role role)
{
    ...
    case meshtastic_Config_DeviceConfig_Role_CLIENT_BASE:
        return "Client Base";
        break;
    case meshtastic_Config_DeviceConfig_Role_CLIENT_LATE:
        return "Client Late";
        break;
