...
void menuHandler::LoraRegionPicker(uint32_t duration)
{
    static const LoraRegionOption regionOptions[] = {
        ...
        {"US", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_US},
        {"EU_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_EU_433},
        {"EU_868", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_EU_868},
        {"CN", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_CN},
        {"JP", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_JP},
        {"ANZ", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_ANZ},
        {"KR", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_KR},
        {"TW", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_TW},
        {"RU", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_RU},
        {"IN", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_IN},
        {"NZ_865", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_NZ_865},
        {"TH", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_TH},
        {"LORA_24", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_LORA_24},
        {"UA_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_UA_433},
        {"UA_868", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_UA_868},
        {"MY_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_MY_433},
        {"MY_919", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_MY_919},
        {"SG_923", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_SG_923},
        {"PH_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_PH_433},
        {"PH_868", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_PH_868},
        {"PH_915", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_PH_915},
        {"ANZ_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_ANZ_433},
        {"KZ_433", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_KZ_433},
        {"KZ_863", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_KZ_863},
        {"NP_865", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_NP_865},
        {"BR_902", OptionsAction::Select, meshtastic_LoRaConfig_RegionCode_BR_902},
    };
...
void menuHandler::RadioPresetPicker()
{
    static const RadioPresetOption presetOptions[] = {
        {"Back", OptionsAction::Back},
        {"LongTurbo", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_LONG_TURBO},
        {"LongModerate", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_LONG_MODERATE},
        {"LongFast", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_LONG_FAST},
        {"MediumSlow", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_MEDIUM_SLOW},
        {"MediumFast", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_MEDIUM_FAST},
        {"ShortSlow", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_SHORT_SLOW},
        {"ShortFast", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_SHORT_FAST},
        {"ShortTurbo", OptionsAction::Select, meshtastic_LoRaConfig_ModemPreset_SHORT_TURBO},
    };
