...
typedef struct _meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget {
 ...
 Falls back to the running config preset if unset. */
    bool has_preset;
    meshtastic_LoRaConfig_ModemPreset preset;
...
typedef struct _meshtastic_ModuleConfig_MeshBeaconConfig {
 ...
 A remote admin can only set this field to their own node ID. */
    ...
    meshtastic_LoRaConfig_RegionCode broadcast_offer_region;
    /* Optional modem preset to advertise in the MeshBeacon offer_preset field. */
    bool has_broadcast_offer_preset;
    meshtastic_LoRaConfig_ModemPreset broadcast_offer_preset;
 ...
 BroadcastTarget. The two paths are equal, first-class options; only this representation differs. */
    ...
    meshtastic_LoRaConfig_RegionCode broadcast_on_region;
 ...
 If different from current config, the radio is temporarily switched for TX. */
    ...
    meshtastic_LoRaConfig_ModemPreset broadcast_on_preset;
...
#define meshtastic_ModuleConfig_MeshBeaconConfig_broadcast_offer_region_ENUMTYPE meshtastic_LoRaConfig_RegionCode
#define meshtastic_ModuleConfig_MeshBeaconConfig_broadcast_offer_preset_ENUMTYPE meshtastic_LoRaConfig_ModemPreset
#define meshtastic_ModuleConfig_MeshBeaconConfig_broadcast_on_region_ENUMTYPE meshtastic_LoRaConfig_RegionCode
#define meshtastic_ModuleConfig_MeshBeaconConfig_broadcast_on_preset_ENUMTYPE meshtastic_LoRaConfig_ModemPreset

#define meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_preset_ENUMTYPE meshtastic_LoRaConfig_ModemPreset
#define meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_region_ENUMTYPE meshtastic_LoRaConfig_RegionCode
...
#define meshtastic_ModuleConfig_MeshBeaconConfig_init_default {0, 0, "", false, meshtastic_ChannelSettings_init_default, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN, false, meshtastic_ChannelSettings_init_default, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN, 0, 0, {meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_default, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_default, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_default, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_default}}
#define meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_default {false, _meshtastic_LoRaConfig_ModemPreset_MIN, _meshtastic_LoRaConfig_RegionCode_MIN, false, 0}
...
#define meshtastic_ModuleConfig_MeshBeaconConfig_init_zero {0, 0, "", false, meshtastic_ChannelSettings_init_zero, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN, false, meshtastic_ChannelSettings_init_zero, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN, 0, 0, {meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_zero, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_zero, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_zero, meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_zero}}
#define meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_init_zero {false, _meshtastic_LoRaConfig_ModemPreset_MIN, _meshtastic_LoRaConfig_RegionCode_MIN, false, 0}
...
#define meshtastic_ModuleConfig_MeshBeaconConfig_BroadcastTarget_size 11
#define meshtastic_ModuleConfig_MeshBeaconConfig_size 330
...
#define meshtastic_ModuleConfig_size             334
