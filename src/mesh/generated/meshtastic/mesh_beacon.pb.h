...
typedef struct _meshtastic_MeshBeacon {
 ...
 A client app may offer to switch the user to this channel; firmware never applies it automatically. */
    ...
    meshtastic_LoRaConfig_RegionCode offer_region;
 ...
 Combined with offer_region, tells a client "there is a mesh on this preset/region". */
    ...
    meshtastic_LoRaConfig_ModemPreset offer_preset;
...
#define meshtastic_MeshBeacon_init_default       {"", false, meshtastic_ChannelSettings_init_default, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN}
#define meshtastic_MeshBeacon_init_zero          {"", false, meshtastic_ChannelSettings_init_zero, _meshtastic_LoRaConfig_RegionCode_MIN, false, _meshtastic_LoRaConfig_ModemPreset_MIN}
...
#define meshtastic_MeshBeacon_size               181
