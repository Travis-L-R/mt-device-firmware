...
typedef struct _meshtastic_LoRaPresetGroup {
 ...
 of these regions, or when the current preset is not legal in the new region. */
    meshtastic_LoRaConfig_ModemPreset default_preset;
...
#define meshtastic_LoRaPresetGroup_presets_ENUMTYPE meshtastic_LoRaConfig_ModemPreset
#define meshtastic_LoRaPresetGroup_default_preset_ENUMTYPE meshtastic_LoRaConfig_ModemPreset

#define meshtastic_LoRaRegionPresets_region_ENUMTYPE meshtastic_LoRaConfig_RegionCode
...
#define meshtastic_Data_leap_data_tag            11
...
X(a, STATIC,   OPTIONAL, MESSAGE,  leap_data,        11)
