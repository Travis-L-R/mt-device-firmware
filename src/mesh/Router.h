...
class Router : protected concurrency::OSThread, protected PacketHistory
{
  ...
  public:
    ...
    meshtastic_Config_DestinationsConfig_MeshDestination *findDestinationForAddress(uint32_t n, bool leap_only = false, uint32_t leap_mask = 0);
  ...
  private:
     ...
     */
    void handleReceived(meshtastic_MeshPacket *p, RxSource src = RX_SRC_RADIO, bool mqttOnly = false);
     ...
     */
    void dispatchReceived(meshtastic_MeshPacket *p, RxSource src, bool mqttOnly = false);
